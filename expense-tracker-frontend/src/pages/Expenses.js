...
const Expenses = () => {
  ...
  useEffect(() => {
    const fetchExpenseData = async () => {
      try {
        const response = await fetch(`http://localhost:5000/api/expense/${userEmail}`);
        if (!response.ok) {
  ...
  const avgExpense = expenseData.length > 0 ? (totalExpense / expenseData.length).toFixed(2) : 0;
    ...
    datasets: [
      {
        ...
        data: Object.values(expenseByCategory), // Aggregated amounts
  ...
  return (
    <div className="d-flex">
      ...
      >
        {/* Header */}
        <h2 className="fw-bold text-center" style={{ color: "#4CAF50" }}>Expense Dashboard</h2>
        ...
        {!loading && !error && (
          <div className="d-flex flex-wrap gap-4 mt-4 justify-content-center">
            ...
            >
              ...
              <h4 className="card-title fw-bold mt-3">Total Expense</h4>
            ...
            >
              <MdBarChart size={40} />
              <h4 className="card-title fw-bold mt-3">Average Expense</h4>
              <p className="card-text" style={{ fontSize: "1.5rem", fontWeight: "bold" }}>
            ...
            >
              <h4 className="card-title fw-bold ">Expense by Category</h4>
        ...
        {!loading && !error && (
          <div className="mt-3">
            <h2 className="fw-bold text-center" style={{ color: "#4CAF50" }}>Expense Overview</h2>
            <div className="d-flex flex-wrap gap-4 mt-4 justify-content-center">
              {/* Bar Chart */}
              <div
                style={{
